...
interface IWasabiPoolV2 is IERC165, IERC721Receiver {
    ...
    /**
     * @dev Executes the option for the given nft.
     */
    ...
    /**
     * @dev Returns the id of the option that locked the given nft token, reverts if there is none
     */
    ...
    function getOptionData(
        uint256 _optionId
    ) external view returns (WasabiStructsV2.OptionData memory);
    ...
    /**
     * @dev Checks if nft token unlocked
     */
    ...
    /**
     * @dev accepts the bid for LPs with _nft and _tokenId. If its a put option, _nft and _tokenId can be 0
     */
    function acceptBid(
