...
contract WasabiOptionArbitrageV2 is IERC721Receiver, Ownable, ReentrancyGuard {
    ...
    function arbitrage(
        ...
        WasabiStructsV2.OptionData memory optionData = pool.getOptionData(_optionId);
        if (optionData.optionType == WasabiStructsV2.OptionType.CALL) {
            // Execute Option
            IWasabiPoolV2(_poolAddress).executeOption{value: _value}(_optionId);
            ...
            IWasabiPoolV2(_poolAddress).executeOptionWithSell(_optionId, _tokenId);
        }
