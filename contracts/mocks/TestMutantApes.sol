...
contract TestMutantApes is ERC721Enumerable, Ownable {
    uint256 private currentId = 1;
    uint256 private maxItems = 19438;
    string private baseTokenURI;

    constructor() ERC721("BoredApeYachtClub", "MAYC") {
        baseTokenURI = "https://boredapeyachtclub.com/api/mutants/";
    }
