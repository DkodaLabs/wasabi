...
contract TestSewerPass is ERC721Enumerable, Ownable {
    uint256 private currentId = 0;
    uint256 private maxItems = 30000;
    string private baseTokenURI;

    constructor() ERC721("SewerPass", "SEWER") {
        baseTokenURI = "https://api.mdvmm.xyz/sewerpasses/";
    }
