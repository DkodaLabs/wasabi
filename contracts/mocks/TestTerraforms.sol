...
contract TestTerraforms is ERC721Enumerable, Ownable {
    uint256 private currentId = 1;
    uint256 private maxItems = 9911;
    string private baseTokenURI;

    constructor() ERC721("CryptoDickbutts S3", "CDB") {
        baseTokenURI = "https://mqcmmn3bpx.us-east-1.awsapprunner.com/api/mock/terraforms/";
    }
