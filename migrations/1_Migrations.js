...
module.exports = async function (deployer, _network, accounts) {
  ...
  await deployer.deploy(
    WasabiPoolFactory,
    WasabiOption.address,
    ETHWasabiPool.address,
    ERC20WasabiPool.address,
    WasabiFeeManager.address,
    WasabiConduit.address
  );
  ...
  await deployer.deploy(
    WasabiPoolFactoryV2,
    WasabiOption.address,
    ETHWasabiPoolV2.address,
    ERC20WasabiPoolV2.address,
    WasabiFeeManager.address,
    WasabiConduitV2.address
  );
};
